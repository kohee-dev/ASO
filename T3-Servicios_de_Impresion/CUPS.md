...
**Configuración:**
* Configurar CUPS `/etc/cups/cupsd.conf` ([Ver vídeo](https://youtu.be/6M4oGNn9cVc)). `Allow @LOCAL` significa que vamos a permitir el acceso al servicio vía Web del servidor a todas las máquinas de la red local (LAN).
...
* Crear una archivo "impresion_local.txt" con algún contenido.
